      ...
      <div className="space-y-3">
        {resources.map((r, i) => (
          <a
            ...
            className="block rounded-2xl border border-slate-200 bg-white p-5 transition-colors hover:border-violet-500 hover:bg-violet-50"
          >
            ...
            <span className="mt-3 inline-flex items-center gap-1 text-sm font-medium text-violet-500">
              보러 가기
