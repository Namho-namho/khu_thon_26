  ...
  return (
    <section>
      ...
      <ol className="relative">
        <div className="absolute left-[15px] top-2 bottom-2 w-0.5 bg-sky-200" />
        {timeline.map((step) => (
          <li
            key={step.stepNumber}
            className="relative pl-12 pb-8 last:pb-0"
          >
            <div className="absolute left-0 top-0 z-10 flex h-8 w-8 items-center justify-center rounded-full bg-sky-500 text-sm font-bold text-white shadow-md shadow-sky-500/30">
              {step.stepNumber}
            </div>
